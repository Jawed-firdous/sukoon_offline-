                        ...
                        <div class="md:flex items-center -mx-10">
                            ...
                            <div class="w-full md:w-1/2 px-10">
                                ...
                                <div className="flex justify-center gap-3 relative top-2 md:top-4 py-5 lg:top-6">
                                    ...
                                    <a class="ml-3 text-gray-500" href="https://wa.me/+923322418007?text=https://sukoondiabeticcentre.com/{{ pathname: "/description", query: { productId: val.id } }}" target="_blank">
                                        <FaWhatsapp />
                                    </a>
                                </div>
                            </div>
