...
function forgotPasswordPage() {
    ...
    return (
        <>
            <Head>
                <title>SDC - Forgot password</title>
            </Head>
            {
                contextHolder
            }
...
"
                    >
                        ...
                        <div class="mt-4 self-center text-xl sm:text-sm text-gray-800">
                            Enter email address to access your account
                        </div>
          ...
          "
                            ...
                            <div class="flex w-full relative -top-5">
                            <button
        ...
        "
                                >
                                    <span class="mr-2 uppercase ">Send password reset link </span>
                                    <span>
                                        <svg
                                            class="h-6 w-6"
                                            fill="none"
